...
from layers import (ConvLayer, FeatureAttentionLayer, MultiHeadAttention,
                    PositionwiseFeedForward, PositionalEncoding,
                    TransformerModel, TransformerEncoder, TransformerEncoderLayer)

class Graph_Transformer(nn.Module):
    def __init__(self, n_features, window_size, kernel_size=7, feat_gat_embed_dim=None,
                 use_gatv2=True, dropout=0.2, alpha=0.2, N=2, d_ff=0, h=8):
        super().__init__()
